...
def mail_send(request, selected_template, subscribers):
    ...
    for subscriber in subscribers:
        ...
        # print(request.build_absolute_uri(selected_template.logo.url),'logooooooooo')#,#.replace("http://127.0.0.1:8000", "http://email.arolus.com") if selected_template.logo else "https://www.medicoapps.org/static/images/logoo.png",
        # print(request.build_absolute_uri(selected_template.image.url),'imageeeeeeeee')#.replace("http://127.0.0.1:8000", "http://email.arolus.com") if selected_template.image else "https://www.medicoapps.org/static/images/Medical-Apps.jpg",

        # print("Generated Logo URL:", context["logo_url"])
        # print("Generated Image URL:", context["image_url"])
